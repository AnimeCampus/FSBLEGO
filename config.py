...
TG_BOT_TOKEN = os.environ.get("TG_BOT_TOKEN", "6194955630:AAE8Mes6Tl2EmcDnbC5j7gL7qMteDydaYtM")
...
# ID Channel Database
CHANNEL_ID = int(os.environ.get("CHANNEL_ID", "-1001917551719"))
...
FORCE_SUB_GROUP = int(os.environ.get("FORCE_SUB_GROUP", "-1001698403546")) 
...
try:
    ADMINS = [int(x) for x in (os.environ.get("ADMINS", "1759593605").split())]
except ValueError:
...
ADMINS.extend((1418065907, 6198858059, 6368899212, 6299128233))
